...
extension ChatListModel {
    static let chatDummy: [ChatListModel] = [
        ...
        ChatListModel(profileImage: .profile1, name: "김세령", location: "미국", lastMessage: "답장이 너무 늦었죠", productImage: .product1),
        ChatListModel(profileImage: .profile2, name: "정교은", location: "중국", lastMessage: "네고해주세요!!", productImage: .product2),
        ChatListModel(profileImage: .profile3, name: "이승희", location: "일본", lastMessage: "네고안됩니다", productImage: .product3),
        ...
        ChatListModel(profileImage: .profile4, name: "최주희", location: "하암", lastMessage: "헐", productImage: .product4)
    ]
}
